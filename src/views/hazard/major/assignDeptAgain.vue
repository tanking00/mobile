    ...
    getDetails() {
      getHazardMajorDetails(this.hazardId, this.hazardSubId)
        .then(res => {
          ...
          if (data.hazardMajorSub.length > 1) {
            this.isCanDelete = true
          }
          data.hazardMajorSub.forEach(item => {
            if (item.id === this.hazardSubId) {
              // this.form3 = item
              this.form3.deptName = item.mainDept
              this.form3.mainDeptId = item.mainDeptId
              this.form3.deptManager = item.deptManager
              this.form3.deptManagerId = item.deptManagerId
              this.form3.deptSupervise = item.deptSupervise
              this.form3.deptSuperviseId = item.deptSuperviseId
              this.form3.hazardSubId = item.id
            }
          })
          const stepInfo1 = []
