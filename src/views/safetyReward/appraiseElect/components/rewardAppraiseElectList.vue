...
<template>
  <div>
    ...
    <SearchPanel v-model="show" name="RewardAppraiseElectList" @search="onSearch"></SearchPanel>
  </div>
</template>

<script>
import { getAppraiseList } from '@/api/safetyReward'
import { formatTimeStamp } from '@/utils/timeFormat'

export default {
  name: 'RewardAppraiseElectList',
  model: {
    prop: 'showSearch',
    event: 'change'
  },
